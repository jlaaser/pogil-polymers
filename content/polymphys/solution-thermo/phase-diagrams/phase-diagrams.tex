...
\begin{exercises}
		...
		\begin{enumerate}
			...
			\item First, show that the third derivative of the Flory-Huggins expression for the free energy of a polymer solution is
				...
				\begin{solution}\instructordisplay{
					The Flory-Huggins expression for hte free energy of a polymer solution is 
					\begin{equation*}
						\frac{\Delta G_{mix}}{kT} = \phi_1\phi_2\chi + \phi_1\ln\phi_1 + \frac{\phi_2}{N}\ln\phi_2
					\end{equation*}
					Noting that $\phi_2 = 1-\phi_1$, this expression can alternately be written
					\begin{equation*}
						\frac{\Delta G_{mix}}{kT} = \phi_1(1-\phi_1)\chi + \phi_1\ln\phi_1 + \frac{(1-\phi_1)}{N}\ln(1-\phi_1)
					\end{equation*}
					...
					\begin{align*}
						\frac{1}{N}\frac{1}{(1-\phi_1)^2} &= \frac{1}{\phi_1}\\
	...
	\exercise For the polymer solution whose spinodal curve is shown below,
		...
		\begin{enumerate}
			...
			\item Estimate the interaction parameter, $\chi$, for this polymer mixture at the critical point.
				...
				\begin{solution}\instructordisplay{
					The interaction parameter at the critical point,a gain from the information box on page \pageref{\labelbase:eqn:phi1c}, is
					\begin{equation*}
						\chi_c = \frac{1}{2}\left(\frac{1}{N} + \frac{2}{\sqrt{N}} + 1\right)
					\end{equation*}
	...
	\exercise What do you expect would happen if you prepared a polymer solution at a very high temperature and then rapidly cooled the mixture to a temperature below its critical point?
			
				\begin{solution}\instructordisplay{
					Depending on the composition of the mixture, some or all of the polymer might precipitate out of solution as the temperature is changed such that you move from the one-phase region fo the phase diagram into the two-phase region of the diagram.
