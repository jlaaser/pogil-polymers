...
\begin{model}[Structures of Polymer Crystals]
	...
	\vspace{6pt}
	\centerline{\includegraphics[width=0.6\textwidth]{\figpath/Model1_PE_supercell.pdf}}	
	...
	\vspace{6pt}
	\centerline{\includegraphics[width=0.6\textwidth]{\figpath/Model1_PE_layer.pdf}}	
...
\begin{ctqs}
	...
	\begin{solution}[1.25in]{
		\centerline{\includegraphics[width=0.35\textwidth]{\figpath/Model1_PE_layer_unitcell_blank.pdf}}	
	}
		\centerline{\includegraphics[width=0.35\textwidth]{\figpath/Model1_PE_layer_unitcell_solution.pdf}}
	\end{solution}
...
\begin{infobox}
	...
	\vspace{6pt}
	\centerline{\includegraphics[width=0.4\textwidth]{\figpath/Model1_PE_unitcell_3D.pdf}}
...
\begin{ctqs}
	...
	\vspace{6pt}
	\centerline{\includegraphics[width=0.8\textwidth]{\figpath/Model1_sidechain.pdf}}	
...
\label{\labelbase:mdl:thermodynamics}
	...
	\vspace{6pt}
	\centerline{\includegraphics[width=0.8\textwidth]{\figpath/Model2_lengthscales.pdf}}
...
%	\exercise Give a ``predict which of these pairs of polymers will produce the most crystalline structures'' question
	...
	\exercise Derive the expression for $T_m$ given on page \pageref{\labelbase:info:lamellaeTmelt} by considering the following segment of a crystalline lamella: \label{\labelbase:exc:lamellaeTmelt}
		...
		\centerline{\includegraphics[width=0.4\textwidth]{\figpath/Exc_xtaldimensions.pdf}}
